...
const ChromeLogo: FC<JSX.IntrinsicElements['svg']> = props => (
  <svg {...props} viewBox="1 1 176 176">
    <style
      // eslint-disable-next-line react/no-danger
      dangerouslySetInnerHTML={{
        __html: `.B{clip-path:url(#C)}.C{fill:#3e2723}.D{fill-opacity:.15}.E{fill-opacity:.2}`,
      }}
    />
    <defs>
